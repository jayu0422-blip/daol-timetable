...
(function () {
  ...
  /* 지필평가: {level, school, grade, term, month, days[], subjects?, note?}
     ...
     ※ 2학기 1차 날짜는 그 표를 따랐다. 연초 엑셀과 달랐던 곳: 미사고(10/13~16 → 10/7·8·12·13·14), 미사강변중(9/29·30 → 9/28·29 → 원장 확인 9/22로 다시 9/29·30, 영어 9/29).
  ...
  const EXAMS = [
    ...
    ["중", "미사강변중학교", "2,3학년", "1차지필", 9, [29, 30],
      { 29: { "중2": "국어, 영어", "중3": "영어" }, 30: { "중2": "수학, 과학", "중3": "수학, 과학" } },
      "원장 확인(9/22): 시험 9/29·30, 영어는 은가람중과 같은 9/29(화) — 나머지 과목 배치는 전달표를 하루 민 것"],
