...
set -e
cd "$(dirname "$0")"
for f in copy.js scholars.js scholars_all.js consulting.js config.js manual.js schedule-cal.js course-cal.js academic.js ops-cal.js consult-slots.js exam-ops.js; do
  [ -f "$f" ] || continue
